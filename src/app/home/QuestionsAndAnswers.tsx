...
const QAS = [
      ...
      <>
        ...
        <p>
          <span className="font-semibold">
            1. OpenResume is designed specifically for the INDIA job market and
            best practices.
          </span>
          <br />
          ...
          options that are aligned with INDIA best practices. For example, it
  ...
  },
  {
    ...
    answer: (
      <p>
        OpenResume was created by ARYAN MORE . As a first generation immigrant to the INDIA, we had made many mistakes
